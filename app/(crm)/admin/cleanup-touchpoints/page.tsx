      ...
      <Card padding="md">
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={running}
            className="w-full px-6 py-3 bg-linear-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {running ? (
