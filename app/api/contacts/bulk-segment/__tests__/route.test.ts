...
describe("POST /api/contacts/bulk-segment", () => {
  ...
  describe("Input validation", () => {
    it("should return 400 if contactIds is not an array", async () => {
      const req = new Request("http://localhost/api/contacts/bulk-segment", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: "not-an-array", segment: "Enterprise" }),
      });
    ...
    it("should return 400 if contactIds is empty", async () => {
      const req = new Request("http://localhost/api/contacts/bulk-segment", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: [], segment: "Enterprise" }),
      });
    ...
    it("should return 400 if segment is not a string or null", async () => {
      const req = new Request("http://localhost/api/contacts/bulk-segment", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: mockContactIds, segment: 123 }),
      });
      ...
      expect(response.status).toBe(400);
      expect(data.error).toContain("segment must be a string or null");
    });

    it("should accept null segment", async () => {
      ...
      const req = new Request("http://localhost/api/contacts/bulk-segment", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: mockContactIds, segment: null }),
      });
  ...
  describe("Bulk update functionality", () => {
    it("should update all contacts successfully", async () => {
      ...
      const req = new Request("http://localhost/api/contacts/bulk-segment", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: mockContactIds, segment: "Enterprise" }),
      });
    ...
    it("should process contacts in batches of 10", async () => {
      ...
      const req = new Request("http://localhost/api/contacts/bulk-segment", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: largeContactIds, segment: "Enterprise" }),
      });
