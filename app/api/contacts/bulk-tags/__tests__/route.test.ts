...
describe("POST /api/contacts/bulk-tags", () => {
  ...
  describe("Input validation", () => {
    it("should return 400 if contactIds is not an array", async () => {
      const req = new Request("http://localhost/api/contacts/bulk-tags", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: "not-an-array", tags: ["tag1"] }),
      });
    ...
    it("should return 400 if contactIds is empty", async () => {
      const req = new Request("http://localhost/api/contacts/bulk-tags", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: [], tags: ["tag1"] }),
      });
    ...
    it("should return 400 if tags is not an array", async () => {
      const req = new Request("http://localhost/api/contacts/bulk-tags", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: mockContactIds, tags: "not-an-array" }),
      });
    ...
    it("should accept empty tags array (converts to null)", async () => {
      ...
      const req = new Request("http://localhost/api/contacts/bulk-tags", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: mockContactIds, tags: [] }),
      });
  ...
  describe("Bulk update functionality", () => {
    it("should update all contacts successfully", async () => {
      ...
      const req = new Request("http://localhost/api/contacts/bulk-tags", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: mockContactIds, tags: ["VIP", "Priority"] }),
      });
    ...
    it("should handle errors gracefully", async () => {
      ...
      const req = new Request("http://localhost/api/contacts/bulk-tags", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: mockContactIds, tags: ["VIP"] }),
      });
    ...
    it("should process contacts in batches of 10", async () => {
      ...
      const req = new Request("http://localhost/api/contacts/bulk-tags", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contactIds: largeContactIds, tags: ["VIP"] }),
      });
